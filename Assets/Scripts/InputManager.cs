...
public class InputManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        onFoot.ToggleFlashlight.performed += ctx => { if (flashlight != null) flashlight.normLight(); };
        onFoot.ToggleMaxFlash.performed += ctx => { if (flashlight != null) flashlight.maxLight(); };
    ...
    private void Start()
    {
        ...
        if (flashlight == null) flashlight = GetComponent<Flashlight>();
    }
}